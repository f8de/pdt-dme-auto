...
QUERIES = [
    ("Row counts", """
        SELECT 'tbl_customer' AS tbl, COUNT(*) AS rows FROM c02.tbl_customer
        UNION ALL SELECT 'tbl_customer_insurance', COUNT(*) FROM c02.tbl_customer_insurance
        UNION ALL SELECT 'tbl_customer_notes',     COUNT(*) FROM c02.tbl_customer_notes
    ...
    ("c02.tbl_customer — last 50 ALL cols", "SELECT * FROM c02.tbl_customer ORDER BY ID DESC LIMIT 50"),
    ("c02.tbl_customer_insurance — last 50 ALL cols", "SELECT * FROM c02.tbl_customer_insurance ORDER BY ID DESC LIMIT 50"),
    ("c02.tbl_customer_notes — ALL rows ALL cols", "SELECT * FROM c02.tbl_customer_notes ORDER BY ID DESC"),
    ("NULL/empty — tbl_customer", """
        SELECT
    ...
    """),
    ("NULL/empty — tbl_customer_insurance", """
        SELECT
    ...
    """),
    ("Full join — patient + doctor + insurance", """
        SELECT
